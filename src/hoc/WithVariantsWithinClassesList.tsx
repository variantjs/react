...
import { ObjectWithClassesList, parseVariantWithClassesList, WithVariantPropsAndClassesList } from '@variantjs/core'
...
const withVariantsWithinClassesList = <P extends ObjectWithClassesList>(
  ...
  return class extends React.Component<WithVariantPropsAndClassesList<P>> {
    ...
    render() {
      ...
      const props = parseVariantWithClassesList(this.props, classesListKeys, globalConfiguration, defaultConfiguration)
